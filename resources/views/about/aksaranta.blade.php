...
@section('content')
    ...
    <section class="relative w-full h-[70vh] min-h-[480px] max-h-[760px] overflow-hidden flex items-center">
        ...
        <div class="w-full max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-28">
            <div class="max-w-3xl">
                <h1 class="font-bold text-3xl sm:text-5xl md:text-6xl leading-tight">Aksaranta</h1>
                ...
                <div class="mt-6 flex gap-3 flex-wrap">
                    <a href="{{ route('learn.index') }}" class="px-5 py-3 rounded-xl bg-red-500 hover:bg-red-600 transition">Mulai Belajar</a>
                    <a href="{{ route('culture') }}" class="px-5 py-3 rounded-xl bg-white/10 hover:bg-white/20 transition">Jelajahi Budaya</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="w-full max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-28">
            ...
            <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <a href="{{ route('learn.index') }}" class="bg-white/5 rounded-2xl p-6 hover:bg-white/10 transition block">
                    ...
                    <p class="font-sans text-sm text-white/80 mt-1">Latih membaca/menulis dengan modul interaktif dan contoh nyata.</p>
                </a>
                <a href="{{ route('culture') }}" class="bg-white/5 rounded-2xl p-6 hover:bg-white/10 transition block">
                    ...
                    <p class="font-sans text-sm text-white/80 mt-1">Pelajari falsafah Dalihan Na Tolu, sistem marga, dan tradisi.</p>
                </a>
                <a href="{{ route('history') }}" class="bg-white/5 rounded-2xl p-6 hover:bg-white/10 transition block">
                    ...
                    <p class="font-sans text-sm text-white/80 mt-1">Garis waktu evolusi Aksara Batak sampai era digital.</p>
                </a>
                <a href="{{ route('virtual.index') }}" class="bg-white/5 rounded-2xl p-6 hover:bg-white/10 transition block">
                    ...
                    <p class="font-sans text-sm text-white/80 mt-1">Jelajah imersif destinasi ikonik Sumatera Utara.</p>
                </a>
                <a href="{{ route('kamus-aksara') }}" class="bg-white/5 rounded-2xl p-6 hover:bg-white/10 transition block">
                    ...
                    <p class="font-sans text-sm text-white/80 mt-1">Glosarium multi-dialek dan daftar karakter per sub-etnis.</p>
                </a>
                <a href="{{ route('batak-songs') }}" class="bg-white/5 rounded-2xl p-6 hover:bg-white/10 transition block">
                    ...
                    <p class="font-sans text-sm text-white/80 mt-1">Koleksi lagu-lagu Batak dan artis pilihan.</p>
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="w-full max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-28">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
                <div class="bg-white/5 rounded-3xl p-6 sm:p-10">
                    ...
                    <ul class="mt-4 space-y-2 text-sm font-sans text-white/80 list-disc list-inside">
    ...
    <section class="flex flex-col gap-8 mt-12">
        <div class="w-full max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-28">
            <div class="rounded-3xl p-6 sm:p-10 bg-white/5">
                ...
                <p class="text-center font-sans text-sm sm:text-base text-white/80 max-w-3xl mx-auto">
