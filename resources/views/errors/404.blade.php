...
<section class="min-h-[60vh] w-full flex items-center justify-center px-6 md:px-12">
  <div class="text-center max-w-2xl">
    <p class="text-red-400 font-mono text-sm mb-2">Error 404</p>
    <h1 class="text-white text-4xl md:text-6xl font-title mb-4">Halaman tidak ditemukan</h1>
    <p class="text-white/70 mb-8">Maaf, halaman yang Anda cari tidak tersedia atau telah dipindahkan.</p>
