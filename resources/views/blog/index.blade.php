...
@section('content')
    ...
    <section class="w-full pt-24 max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-28 my-8">
        <div class="bg-white/5 rounded-3xl p-6 sm:p-8">
            ...
            <p class="font-sans text-sm sm:text-base dark:text-white/80 mt-2">Cerita, wawasan, dan pembaruan seputar budaya Batak.</p>
        </div>
    </section>
    ...
    <section class="w-full max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-28 my-12 lg:my-16 flex flex-col gap-5 items-center">
        ...
        <p class="font-sans w-full sm:w-3/4 text-center dark:text-white/70">Telusuri kumpulan artikel yang dikurasi untuk menemani perjalanan belajarmu.</p>
