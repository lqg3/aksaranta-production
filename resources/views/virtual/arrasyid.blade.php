...
@section('content')
    <section class="w-full max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-28 pt-24">
        ...
        <p class="mt-3 dark:text-white/80 font-sans max-w-3xl">Destinasi santai di Berastagi untuk menikmati camilan khas dengan udara pegunungan yang sejuk.</p>
    </section>
    ...
    <section id="detail-section" class="w-full max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-28 py-16">
        ...
        <nav class="mt-12 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('virtual.taman-alam-lubini') }}" class="inline-flex items-center gap-2 bg-black/10 hover:bg-black/20 dark:bg-white/10 dark:hover:bg-white/20 dark:text-white px-4 py-2 rounded-lg transition-colors">← Prev: Taman Alam Lumbini</a>
                <a href="{{ route('virtual.graha-bunda') }}" class="inline-flex items-center gap-2 bg-black/10 hover:bg-black/20 dark:bg-white/10 dark:hover:bg-white/20 dark:text-white px-4 py-2 rounded-lg transition-colors">Next: Graha Bunda →</a>
      </div>
        </nav>
    </section>
    ...
    <h2 class="text-2xl text-bold dark:text-white"> Virtual Tour Lainnya </h2>
        <div class="mt-8 flex flex-wrap gap-3">
            ...
            <a href="{{ route('virtual.arrasyid') }}" class=" bg-black/20 dark:bg-white/10 hover:bg-black/20 dark:hover:bg-white/20 dark:text-white/90  hover:text-black/80 dark:hover:text-white px-4 py-2 rounded-lg transition-colors">Arrasyiid</a>
