...
@section('content')
    ...
    <section id="detail-section" class="w-full max-w-[1440px] mx-auto px-6 sm:px-12 lg:px-28 py-16">
        <div class="rounded-2xl overflow-hidden shadow-xl bg-white/5">
            <iframe class="w-full h-[340px] sm:h-[420px] md:h-[540px]" src="https://www.google.com/maps/embed?pb=!3m2!1sen!2sid!4v1754725378569!5m2!1sen!2sid!6m8!1m7!1sCAoSHENJQUJJaEEwNV9xczVHNGoxeFZFVnQ4TERFbWw.!2m2!1d2.551508121255187!2d98.67448302158412!3f123.00568006138185!4f-8.20967505931226!5f0.7820865974627469" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
