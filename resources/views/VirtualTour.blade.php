...
<html lang="en">
  <head>
    ...
    <style>
      * {
      ...
      .box-peta1{
        background-image: url('img/raja-ampat.jpg'); /* Gambar latar belakang */
    width: 100%;
    height: 600px;
  ...
  <body>
    ...
    <div class="box-peta1">
        {{-- <img src="img/raja-ampat.jpg" alt="" height="450" width="100%"/> --}}
        <div class="content">
            <h1>Virtual Tour</h1>
    ...
    <div class="box-peta">
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d507184.21857556753!2d107.22508288990116!3d-6.72380515750726!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1shutan!5e0!3m2!1sid!2sid!4v1672700539750!5m2!1sid!2sid"
        width="600"
        height="450"
        style="border: 0"
        allowfullscreen=""
    ...
    <div class="container-virtual-tour">
      <div class="box-tour">
        <div class="img-tour">
          <a href="raja-ampat.html"><img src="img/raja-ampat.jpg" alt="" /></a>
        </div>

        <div class="kalimat-tour">
          <div class="flex-tour">
            <p>PAPUA BARAT DAYA</p>
          </div>
          <h3>Raja Ampat</h3>
        </div>
      </div>
      ...
      <div class="box-tour">
        <div class="img-tour">
          <a href="borobudur.html"><img src="img/borobudur.jpg" alt="" /></a>
        </div>
